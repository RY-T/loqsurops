...
rule all:
    input:
        ...
        expand('dm6.17_flybase_FT_{FT}.gff', FT=FT_list), 'dm6_flybase.db',
        ...
        expand('raw_exon_TE_bedfiles/dm6.17_flybase_FT_exon_PT_{PT}.bed', PT=Exon_PT_list),
        expand('merged_bedfiles/dm6.17_flybase_FT_exon_PT_{PT}.merge.bed', PT=Exon_PT_list),
        'raw_exon_TE_bedfiles/dm6.17_flybase_FT_transposable_element.bed',
        'merged_bedfiles/dm6.17_flybase_FT_transposable_element.merge.bed'
...
rule extract_individual_exon:
    input:
        in_exon= 'dm6.17_flybase_FT_exon_PTID.bed',
        #in_TE= 'dm6.17_flybase_FT_transposable_element.gff'
    output:
        out_exon = expand('raw_exon_TE_bedfiles/dm6.17_flybase_FT_exon_PT_{PT}.bed', PT=Exon_PT_list),
        #out_TE = 'raw_exon_TE_bedfiles/dm6.17_flybase_FT_transposable_element.bed'
    run:
        import pandas as pd
        counter = 0
        shell("mkdir -p raw_exon_TE_bedfiles")
...
rule merge_exon_Type:
    input:
        in_exon ='raw_exon_TE_bedfiles/dm6.17_flybase_FT_exon_PT_{PT}.bed',
        #in_TE = 'raw_exon_TE_bedfiles/dm6.17_flybase_FT_transposable_element.bed'
    output:
        out_exon='merged_bedfiles/dm6.17_flybase_FT_exon_PT_{PT}.merge',
        #out_TE = 'merged_bedfiles/dm6.17_flybase_FT_transposable_element.merge.bed'
    run:
        import pandas as pd
        import os
        counter = 0
        shell("mkdir -p merged_bedfiles")
        shell("sort-bed {input.in_exon} | bedtools merge -s -c 4 -o collapse -i - | \
        sort-bed - > {output.out_exon}")

rule convert_to_bed:
    input:
        in_exon = expand('merged_bedfiles/dm6.17_flybase_FT_exon_PT_{PT}.merge', PT=Exon_PT_list)
        #in_TE = 'raw_exon_TE_bedfiles/dm6.17_flybase_FT_transposable_element.bed'
    output:
        out_exon= expand('merged_bedfiles/dm6.17_flybase_FT_exon_PT_{PT}.merge.bed', PT=Exon_PT_list)
    run:
        counter = 0
        import pandas as pd
...
rule do_for_TE:
    input:
        gff = 'dm6.17_flybase_FT_transposable_element.gff'
    output:
        bed = 'raw_exon_TE_bedfiles/dm6.17_flybase_FT_transposable_element.bed',
        merge_bed = 'merged_bedfiles/dm6.17_flybase_FT_transposable_element.merge.bed'
    run:
        import pandas as pd
        ...
        bed = 'raw_exon_TE_bedfiles/dm6.17_flybase_FT_transposable_element.bed'
        merge = 'merged_bedfiles/dm6.17_flybase_FT_transposable_element.merge'
